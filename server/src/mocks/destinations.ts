import type { Day, Place, Stay, Trip } from "../types.js";

// ---------------------------------------------------------------------------
// Server-side mock data. Mirrors src/mocks/destinations.ts on the frontend
// with one addition: openHours per place, used by eventsService to answer
// "what's available right now / tonight" style questions.
// ---------------------------------------------------------------------------
...
const buildRomeDays = (): Day[] => [
  {
    ...
    places: [
      ...
      },
      {
        ...
        date: "2026-09-14",
        timeSlot: "13:00",
        openHours: { start: "12:30", end: "15:00" },
      },
      {
        id: placeId("rome"),
        ...
        date: "2026-09-14",
        timeSlot: "Evening",
        openHours: { start: "18:00", end: "23:00" },
      },
    ],
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        date: "2026-09-15",
        timeSlot: "13:30",
        openHours: { start: "12:00", end: "15:30" },
      },
    ],
  },
  {
...
const romeFollowups = {
  ...
  eveningEvent: {
    ...
    openHours: { start: "19:00", end: "23:30" },
  },
  alternativeSight: {
    id: placeId("rome"),
    ...
    places: [
      {
        ...
        date: "2026-10-03",
        timeSlot: "Morning",
        openHours: { start: "09:30", end: "17:30" },
      },
      {
        id: placeId("lisbon"),
  ...
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        date: "2026-10-04",
        timeSlot: "21:00",
        openHours: { start: "20:00", end: "23:59" },
      },
    ],
  },
];
...
const lisbonFollowups = {
  ...
  eveningEvent: {
    ...
    bookingAction: "save" as const,
    openHours: { start: "18:00", end: "23:59" },
  },
  alternativeSight: {
    id: placeId("lisbon"),
    ...
    places: [
      {
        ...
        date: "2026-11-05",
        timeSlot: "Morning",
        openHours: { start: "06:00", end: "18:00" },
      },
      {
        id: placeId("kyoto"),
        name: "Omen Nishiki",
        ...
        date: "2026-11-05",
        timeSlot: "13:00",
        openHours: { start: "11:30", end: "21:00" },
      },
      {
        id: placeId("kyoto"),
  ...
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        date: "2026-11-06",
        timeSlot: "Morning",
        openHours: { start: "08:30", end: "17:00" },
      },
      {
        id: placeId("kyoto"),
        name: "Yudofu Sagano",
        ...
        date: "2026-11-06",
        timeSlot: "13:00",
        openHours: { start: "11:00", end: "20:00" },
      },
    ],
  },
  {
    ...
    places: [
      ...
      },
      {
        ...
        date: "2026-11-07",
        timeSlot: "Evening",
        openHours: { start: "18:00", end: "21:30" },
      },
    ],
  },
];
...
const kyotoFollowups = {
  veganRestaurant: {
    ...
    bookingAction: "save" as const,
    openHours: { start: "11:00", end: "14:00" },
  },
  eveningEvent: {
    id: placeId("kyoto"),
    ...
    bookingAction: "getyourguide" as const,
    openHours: { start: "18:30", end: "23:00" },
  },
  alternativeSight: {
    id: placeId("kyoto"),
...
export function findDestinationById(id: string): Destination {
  return destinations.find((destination) => destination.id === id) ?? defaultDestination;
}
